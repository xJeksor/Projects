...
# Funkcja rysująca punktację na ekranie
def draw_score():
...
# Funkcja rysująca punkty końcowe
def draw_end_game_score():
    font = pygame.font.Font(None, 48)
    player1_score_text = font.render(f"Gracz 1: {player1_score}", True, SCORE_COLOR)
    player2_score_text = font.render(f"Gracz 2: {player2_score}", True, SCORE_COLOR)
    screen.blit(player1_score_text, (SCREEN_WIDTH // 2 - player1_score_text.get_width() // 2, SCREEN_HEIGHT // 2 - 50))
    screen.blit(player2_score_text, (SCREEN_WIDTH // 2 - player2_score_text.get_width() // 2, SCREEN_HEIGHT // 2 + 50))
